...
void loop() 
{
  ...
  if ((V_LED_ModeFinalPrev != V_LED_ModeFinal) || (V_Initialized == false))
    {
      ...
      if (K_LightSettings[V_LED_ModeFinal][LED_ConfigColor] == LED_Color_Rainbow)
       ...
       else if (K_LightSettings[V_LED_ModeFinal][LED_ConfigColor] == LED_Color_Sandstorm)
        {
          for(L_Index = 0; L_Index < C_NUM_LEDS; L_Index++)
            {
              V_LED_Rand[L_Index] = random(0, int(LED_Color_Sandstorm-1));
            } 
        }
    }
  ...
  if (K_LightSettings[V_LED_ModeFinal][LED_ConfigColor] < LED_Color_Sandstorm)
    {
      V_LED_Color = K_LightSettings[V_LED_ModeFinal][LED_ConfigColor];
    }
          ...
          if (V_PulseSpeed >= K_PulseCounts)
            {
              ...
              else if (V_LED_Color >= LED_Color_Sandstorm)
                {
                // This resets the color back to the starting point
                V_LED_Color = LED_Color_Sand;
                }
              V_PulseSpeed = 0;
            }
        }
  ...
  if (K_LightSettings[V_LED_ModeFinal][LED_ConfigColor] == LED_Color_Sandstorm)
    {
      SetLED_Color(LED_Color_Sandstorm);
    }
  else
    {
...
void SetLED_Color(LED_Color L_Color) /* Registers color command input */
{
  ...
  for( L_Index = 0; L_Index < C_NUM_LEDS; L_Index++)
    {
      if(L_MainC == (LED_Color_Rainbow) , (LED_Color_Sandstorm)) /* Sets Rainbow LED */
        {
      ...
      if(L_MainC == LED_Color_Sandstorm) /* Sets Sandstorm LED */
        {
          L_RandNum = V_LED_Rand[L_Index];
          L_Color = LED_Color(L_RandNum);
        
          if(L_Color >= LED_Color_Sandstorm && L_Index < 0 && L_Index > 120)
            {
              L_Color = LED_Color_Blue;
            }
          if(L_Color >= LED_Color_Sandstorm && L_Index >= 25 && L_Index <= 45)
            {
              //L_Color = LED_Color_Red;
              L_Color = LED_Color_Black;
      ...
      /*if(L_MainC == LED_Color_Sandstorm)
       {
        if(L_Color == LED_Color_Blue)
         {
          L_Color = LED_Color_Sand;
      ...
      else if ((L_MainC != LED_Color_Rainbow) && (L_MainC != LED_Color_Duo) && (L_MainC != LED_Color_BlinkR) && (L_MainC != LED_Color_BlinkL) && (L_MainC != LED_Color_Sandstorm))
        {
          L_Color = L_MainC;
        }
